...
function About() {
  ...
  return (
    <>
      ...
      <div className="flex bg-[#292929] w-full">      
        <div className="max-w-3xl mx-auto px-6 py-16 flex flex-col items-center ">
          ...
          <div className="w-full space-y-6 text-gray-700 dark:text-gray-300 text-base sm:text-lg leading-relaxed">
              <p>
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 sm:p-8 space-y-4 my-8 shadow-sm">
